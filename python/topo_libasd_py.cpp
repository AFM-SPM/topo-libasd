...
#include <topo_libasd/topo_libasd.hpp>
#include <fstream>
#include <sstream>
...
void add_read_header(py::module &mod) // {{{
{
    ...
    mod.def(
        ...
        [](const std::string &fname) -> py::object
        {
            ...
            {
            case 0:
                return py::cast(asd::read_header<asd::version<0>>(ifs));
            case 1:
                return py::cast(asd::read_header<asd::version<1>>(ifs));
            case 2:
                return py::cast(asd::read_header<asd::version<2>>(ifs));
            default:
...
{
    py::class_<asd::FrameData<std::int16_t, asd::container::vec>>(mod, "RawFrameData", py::buffer_protocol())
    ...
    py::class_<asd::FrameData<double, asd::container::vec>>(mod, "FrameData", py::buffer_protocol())
...
{
    py::class_<asd::Frame<std::int16_t, asd::container::vec>>(mod, "RawFrame")
        .def(py::init<>())
        ...
        .def(
            "image", [](asd::Frame<std::int16_t, asd::container::vec> *self) -> py::array_t<std::int16_t>
    ...
    py::class_<asd::Frame<double, asd::container::vec>>(mod, "Frame")
        .def(py::init<>())
        ...
        .def(
            "image", [](asd::Frame<double, asd::container::vec> *self) -> py::array_t<double>
...
void add_data_classes(py::module &mod)
{
    ...
    add_data_class<
        asd::Data<std::int16_t, asd::ch<1>, asd::ver<0>, asd::container::vec>>(mod, "RawData1ch_v0", "type: Header_v0\nheader information",
                                                                               "type: Array<Array<FrameData>>\nchannels (array of frames)");
    add_data_class<
        asd::Data<std::int16_t, asd::ch<1>, asd::ver<1>, asd::container::vec>>(mod, "RawData1ch_v1", "type: Header_v1\nheader information",
                                                                               "type: Array<Array<FrameData>>\nchannels (array of frames)");
    add_data_class<
        asd::Data<std::int16_t, asd::ch<1>, asd::ver<2>, asd::container::vec>>(mod, "RawData1ch_v2", "type: Header_v2\nheader information",
                                                                               "type: Array<Array<FrameData>>\nchannels (array of frames)");

    add_data_class<
        asd::Data<std::int16_t, asd::ch<2>, asd::ver<0>, asd::container::vec>>(mod, "RawData2ch_v0", "type: Header_v0\nheader information", "type: Array<FrameData>\nframes");
    add_data_class<
        asd::Data<std::int16_t, asd::ch<2>, asd::ver<1>, asd::container::vec>>(mod, "RawData2ch_v1", "type: Header_v1\nheader information", "type: Array<FrameData>\nframes");
    add_data_class<
        asd::Data<std::int16_t, asd::ch<2>, asd::ver<2>, asd::container::vec>>(mod, "RawData2ch_v2", "type: Header_v2\nheader information", "type: Array<FrameData>\nframes");

    add_data_class<
        asd::Data<double, asd::ch<1>, asd::ver<0>, asd::container::vec>>(mod, "Data1ch_v0", "type: Header_v0\nheader information", "type: Array<FrameData>\nframes");
    add_data_class<
        asd::Data<double, asd::ch<1>, asd::ver<1>, asd::container::vec>>(mod, "Data1ch_v1", "type: Header_v1\nheader information", "type: Array<FrameData>\nframes");
    add_data_class<
        asd::Data<double, asd::ch<1>, asd::ver<2>, asd::container::vec>>(mod, "Data1ch_v2", "type: Header_v2\nheader information", "type: Array<FrameData>\nframes");

    add_data_class<
        asd::Data<double, asd::ch<2>, asd::ver<0>, asd::container::vec>>(mod, "Data2ch_v0", "type: Header_v0\nheader information",
                                                                         "type: Array<Array<FrameData>>\nchannels (array of frames)");
    add_data_class<
        asd::Data<double, asd::ch<2>, asd::ver<1>, asd::container::vec>>(mod, "Data2ch_v1", "type: Header_v1\nheader information",
                                                                         "type: Array<Array<FrameData>>\nchannels (array of frames)");
    add_data_class<
        asd::Data<double, asd::ch<2>, asd::ver<2>, asd::container::vec>>(mod, "Data2ch_v2", "type: Header_v2\nheader information",
                                                                         "type: Array<Array<FrameData>>\nchannels (array of frames)");
    return;
} // }}}
